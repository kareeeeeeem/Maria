...
class MemberDataEntryScreen extends StatefulWidget {
  static const String routeName = '/MemberDataEntryScreen';
  ...
  Future<void> _saveUserData() async {
    ...
    try {
      ...
      await _firestore.collection('users').doc(user.uid).set(
          ...
          // 🔴🔴 أهم إضافة: حفظ علامة اكتمال البيانات في SharedPreferences
      final SharedPreferences prefs = await SharedPreferences.getInstance();
      await prefs.setBool('data_completed', true); // ✅ الآن البيانات مكتملة
      print("✅ تم تعيين حالة إكمال البيانات إلى (مكتملة) بنجاح.");
      // 🔴🔴 نهاية الإضافة
